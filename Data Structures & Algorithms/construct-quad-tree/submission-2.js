...
class Solution {
     ...
     */
    /*
    This is not really a problem related to trees. Basically all that needed
    to be done was to loop all over the matrix find if values are same or not
    which is done using a set and then subdivide the grid into 4 equal parts
    and repeat the operation. If the grid contains the same values then just 
    make a node and the connect all the nodes.
    */
