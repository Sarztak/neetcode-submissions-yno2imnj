...
class Codec {
     ...
     */
    /**
     * The approach to serialize using queue was correct, but then I proceeded to 
     * deserialize using a stack and some weird quack. The deserialize should use 
     * queue as well. Since in JS there is no queue data structure this has to be done
     * using an array as below.
     */
    deserialize(data) {
